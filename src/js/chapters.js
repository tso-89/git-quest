...
(function (root, factory) {
  ...
  var chapters = [
    ...
    // ------------------------------------------------------------------- 00
    {
      ...
      blocks: [
        { p: 'Everyone arrives here the same way. A folder with <code>report.docx</code>, <code>report_v2.docx</code>, <code>report_v2_FINAL.docx</code>, and <code>report_v2_FINAL_actually.docx</code> — and no idea which one the good paragraph is in. And everyone has, at least once, deleted something important and only realised later.' },
        ...
        { p: 'And now, with the recent increase in general AI adoption, there is a new benefit too: AI coding agents change files faster than anyone can watch, and git is how you keep up with what they did — and put it back when you need to.' },
